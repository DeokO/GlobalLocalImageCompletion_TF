...
#Image setting
parser.add_argument('--input_width', dest='input_width', default=256, help='input image width')
parser.add_argument('--input_height', dest='input_height', default=256, help='input image height')
...
#tmp
parser.add_argument('--mode', dest='DS_MODE', default='client', help='mode')
parser.add_argument('--port', dest='DS_PORT ', default=57961, help='port')
